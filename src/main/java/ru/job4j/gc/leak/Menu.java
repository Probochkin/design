...
public class Menu {
    ...
    public static final String MENU = "Введите 1 для создание поста." + System.lineSeparator() +
                "Введите 2, чтобы создать определенное количество постов."  + System.lineSeparator() +
               "Введите 3, чтобы показать все посты." + System.lineSeparator() +
                "Введите 4, чтобы удалить все посты." + System.lineSeparator() +
                "Введите любое другое число для выхода." + System.lineSeparator()
            ;
